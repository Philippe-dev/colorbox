...
(function (t, e, i) {
    ...
    function r(e, i) {
        i !== Object(i) && (i = {}),
            ...
            (this.get = function (e) {
                var i = this.value(e);
                return typeof i === "function" ? i.call(this.el, this) : i;
            });
    }
    function h(t) {
        var e = W.length,
    ...
    var v,
        ...
        ce = (function () {
            ...
            function i() {
                S.html(_.get("slideshowStop")).off(s).one(s, n),
                    ae.on(ne, e).on(ie, t),
                    x.removeClass(a + "off").addClass(a + "on");
            }
            function n() {
                t(),
                    ae.off(ne, e).off(ie, t),
            ...
            function o() {
                (r = !1), S.hide(), t(), ae.off(ne, e).off(ie, t), x.removeClass(a + "off " + a + "on");
            }
            var r,
                h,
                a = Z + "Slideshow_",
        ...
        (t(p),
            (J =
                ...
                function (e, i) {
                    ...
                    return (
                        (e = e || {}),
                        typeof o === "function" && ((o = t("<a/>")), (e.open = !0)),
                        o[0]
                            ? (p(),
                                m() &&
                                (i && (e.onComplete = i),
